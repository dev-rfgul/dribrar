            ...
            <div className="bg-gray-100" id="navbar">
                ...
                <div className="fixed z-50 top-0 left-0 right-0 bg-white shadow-md">
                    <div className="flex items-center justify-between px-4 py-2 md:px-6 md:py-1"> {/* Adjusted padding */}
                        <div>
                            <img className="w-20 md:w-28" src="https://www.rfgul.live/images/logo.png" alt="logo" />
                        </div>
                    ...
                    >
                        <ul className="space-y-2">
                            ...
                            <li>
                                <ScrollLink to="skills" smooth={true} duration={500} className="block text-lg hover:text-blue-600 transition-colors cursor-pointer">
                                    Skills
                                </ScrollLink>
                            </li>
                            <li>
